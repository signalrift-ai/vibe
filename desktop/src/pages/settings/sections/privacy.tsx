...
export function PrivacySection({ vm }: { vm: SettingsViewModel }) {
	...
	return (
		<div className="space-y-5">
			...
			<Button variant="ghost" onMouseDown={guard(() => openUrl(config.privacyPolicyURL))} className="h-11 w-full justify-between rounded-xl border border-border/55 bg-card/92 px-4 font-medium hover:bg-accent/55">
